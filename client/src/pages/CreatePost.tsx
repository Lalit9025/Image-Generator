...
import { getRandomPrompts } from "../utills";
     ...
     <div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          ...
          <button type="submit" className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center">{loading ? 'Sharing' : 'share with the community'}
          </button>
        </div>
